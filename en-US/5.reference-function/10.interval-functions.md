...
| result (#additional-information) | The resulting interval, which equals `addend1` + `addend2`.                                                                                                                                                 |
...
| outinter (#additional-information) | The output interval.                                                                                                                                                                                        |
...
| valid (#additional-information)   | Returns 0 if the interval is valid.                                                                                                                                                                         |
...
| result (#additional-information) | The comparison result. For more information, see [Additional information](#p-dv1-r21-j6v) in this section.                                                                                  |
...
| result (#additional-information)  | The resulting interval (`dividend`/`divisor`).                                                                                                                                                              |
...
| hndl (IN)      | The OCI user session handle or environment handle.                                                                                                                                                          |
| err (IN/#additional-information)   | The error handle. If any error occurs, it is recorded in `err`, and the function returns `OCI_ERROR`. You can call [OCIErrorGet](/zh-CN/5.reference-function/7.miscellaneous-functions.md) to obtain the diagnostic information. |
| interval (#additional-information) | The resulting interval.                                                                                                                                                                                     |
...
| result (#additional-information)   | The resulting interval.                                                                                                                                                                                     |
...
| hndl (IN)     | The OCI user session handle or environment handle.                                                                                                                                                          |
| err (IN/#additional-information)  | The error handle. If any error occurs, it is recorded in `err`, and the function returns `OCI_ERROR`. You can call [OCIErrorGet](/zh-CN/5.reference-function/7.miscellaneous-functions.md) to obtain the diagnostic information. |
| dy (#additional-information)      | The number of days.                                                                                                                                                                                         |
| hr (#additional-information)      | The number of hours.                                                                                                                                                                                        |
| mm (#additional-information)      | The number of minutes.                                                                                                                                                                                      |
| ss (#additional-information)      | The number of seconds.                                                                                                                                                                                      |
| fsec (#additional-information)    | The number of nanoseconds.                                                                                                                                                                                  |
...
| hndl (IN)     | The OCI user session handle or environment handle.                                                                                                                                                          |
| err (IN/#additional-information)  | The error handle. If any error occurs, it is recorded in `err`, and the function returns `OCI_ERROR`. You can call [OCIErrorGet](/zh-CN/5.reference-function/7.miscellaneous-functions.md) to obtain the diagnostic information. |
| yr (#additional-information)      | The year.                                                                                                                                                                                                   |
| mnth (#additional-information)    | The month.                                                                                                                                                                                                  |
| interval (IN) | The input interval.                                                                                                                                                                                         |
...
| result (#additional-information) | The resulting interval (`inter` \* `nfactor`).                                                                                                                                                              |
...
| result (#additional-information)    | The resulting interval (`minuend` - `subtrahend`).                                                                                                                                                          |
...
| number (#additional-information)  | The resulting Oracle `NUMBER`, in the unit of year for `YEARMONTH` intervals and in the unit of day for `DAYSECOND` intervals.                                                                              |
...
| buffer (#additional-information)    | The buffer for storing the result.                                                                                                                                                                          |
| buflen (IN)     | The length of the buffer.                                                                                                                                                                                   |
| resultlen (#additional-information) | The length of the result stored in the buffer.                                                                                                                                                              |
