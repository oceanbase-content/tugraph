...
| result (OUT)          | The comparison result. For more information, see the table in the [Additional information](#sectiondiv-m9t-wum-s5l) section.                                                                |
...
| result (OUT) | The return value. For more information, see the table in the [Additional information](#sectiondiv-m9c-e86-sup) section.                                                                     |
