...
- 结果集标签展示及功能
  ![alt 结果集标签](https://tugraph-web-static.oss-cn-beijing.aliyuncs.com/%E6%96%87%E6%A1%A3/2.Operating/8.tugraph-browser-result-01.png)
  - 这里展示了结果集的所有类型统计
  - 点击不同的“label（标签）”，可以进行以下修改操作
    ...
    - 修改默认展示属性或系统属性
    - 配置当前类型的过滤
      ![alt 结果集过滤](https://tugraph-web-static.oss-cn-beijing.aliyuncs.com/%E6%96%87%E6%A1%A3/2.Operating/10.tugraph-browser-filter.png)
    - 布局修改
      - 力导布局
      - 网格布局
      - 树形布局
    ...
    - 边聚合
      - 相同类型，方向的边可以进行合并
        ![alt 边聚合](https://tugraph-web-static.oss-cn-beijing.aliyuncs.com/%E6%96%87%E6%A1%A3/2.Operating/11.tugraph-browser-mergeedge-01.png)
    - 编辑模式
      ![alt 编辑模式](https://tugraph-web-static.oss-cn-beijing.aliyuncs.com/%E6%96%87%E6%A1%A3/2.Operating/12.tugraph-browser-edit.png)
      - 创建节点和关系
    - 停止布局
...
- 点边模型
  ![alt 查询](https://tugraph-web-static.oss-cn-beijing.aliyuncs.com/%E6%96%87%E6%A1%A3/2.Operating/13.tugraph-browser-schema.png)
- 点边模型支持实时的、增、删、改、查
